...
class TestBaseModel(unittest.TestCase):
    ...
    def test_add_method_raises_typeerror_if_not_ints(self):
        self.assertRaises(TypeError, self.testmodel.id, "Hello", "World")
    ...
    def test_assert_dict_contains_subset(self):
        ...
        # deprecated please use the above self.assertDictContainsSubset(expected, actual)
    ...
    # more from: https://docs.python.org/3/library/unittest.html#unittest.TestCase
